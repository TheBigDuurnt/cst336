<?php
    ...
    // Check to see if the search form has been submitted
    if (isset($_GET['query'])) {
    ...
    // If the itemName is set, put it in the session car and direct the user to the shopping cart
    if (isset($_POST['itemName'])) {
        ...
        // must be passed by reference so that each itesm can be updated!
